...
public class SuggestBing implements ISuggest {

    private static final String SUGGEST_URL = "https://api.bing.net/osjson.aspx?FORM=OPERAS&Market={{LANG}}&Query={{TERMS}}";
