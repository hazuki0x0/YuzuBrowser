...
import jp.hazuki.yuzubrowser.toolbar.ToolbarManager.Companion.LOCATION_BOTTOM
import jp.hazuki.yuzubrowser.toolbar.ToolbarManager.Companion.LOCATION_BOTTOM_ALWAYS
import jp.hazuki.yuzubrowser.toolbar.ToolbarManager.Companion.LOCATION_BOTTOM_OVERLAY_ALWAYS
import jp.hazuki.yuzubrowser.toolbar.ToolbarManager.Companion.LOCATION_FIXED_WEB
import jp.hazuki.yuzubrowser.toolbar.ToolbarManager.Companion.LOCATION_FLOAT_BOTTOM
import jp.hazuki.yuzubrowser.toolbar.ToolbarManager.Companion.LOCATION_LEFT
import jp.hazuki.yuzubrowser.toolbar.ToolbarManager.Companion.LOCATION_RIGHT
import jp.hazuki.yuzubrowser.toolbar.ToolbarManager.Companion.LOCATION_TOP
import jp.hazuki.yuzubrowser.toolbar.ToolbarManager.Companion.LOCATION_TOP_ALWAYS
...
open class BrowserToolbarManager(context: Context, override val containerView: View, controller: ActionController, iconManager: ActionIconManager, requestCallback: RequestCallback) : ToolbarManager, LayoutContainer {
    ...
    override val urlBar = UrlBar(context, controller, iconManager, requestCallback)
