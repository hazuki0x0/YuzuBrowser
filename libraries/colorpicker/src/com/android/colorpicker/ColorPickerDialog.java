...
public class ColorPickerDialog extends DialogFragment implements OnColorSelectedListener {
    ...
    public void onColorSelected(int color) {
        ...
        if (getTargetFragment() instanceof OnColorSelectedListener) {
            ...
            ((OnColorSelectedListener) getParentFragment()).onColorSelected(color);
        } else if (getActivity() instanceof OnColorSelectedListener) {
            ((OnColorSelectedListener) getActivity()).onColorSelected(color);
        }
