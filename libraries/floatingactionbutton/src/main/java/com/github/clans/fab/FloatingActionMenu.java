...
public class FloatingActionMenu extends ViewGroup {
    ...
    public void setMenuButtonColorNormalResId(int colorResId) {
        mMenuColorNormal = ResourcesCompat.getColor(getResources(), colorResId, getContext().getTheme());
    ...
    public void setMenuButtonColorPressedResId(int colorResId) {
        mMenuColorPressed = ResourcesCompat.getColor(getResources(), colorResId, getContext().getTheme());
    ...
    public void setMenuButtonColorRippleResId(int colorResId) {
        mMenuColorRipple = ResourcesCompat.getColor(getResources(), colorResId, getContext().getTheme());
